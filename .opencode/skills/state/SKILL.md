...
- Refresh it on task completion, reminder creation, and commit confirmation.
...
2. Confirm to the user: "Saved to STATE.md."
...
- If STATE.md is not committed, remind the user to commit it so the record survives.
